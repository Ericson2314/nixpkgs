...
mkDerivation {
  ...
  makeFlags = [
    ...
    # "i386" and "amd64". Makefile.com also selects the per-ISA link modules
    # with $(LINK_OBJS_$(MACH)), so this decides whether xen_link.o and
    # misc_link_i386.o are built at all.
    "MACH=i386"
    "MACH64=amd64"
