{ stdenv, fetchurl, substituteAll, python3, gst_all_1, wrapGAppsHook, gobject-introspection-tools
...
python3.pkgs.buildPythonApplication rec {
  ...
  nativeBuildInputs = [ gobject-introspection-tools python3.pkgs.distutils_extra intltool wrapGAppsHook ];
  buildInputs = [
