...
# always be readily accomplished, hence the purpose of this package index. The
# `runPackages` argument here is the future stage from which to pull the
# dependencies to inject. Care must be taken to avoid cycles--i.e. use unwrapped
# or less-wrapped version of the tools when building the packages that are then
# injected here.
#
...

{
  ...
  wrapCC = wrapCCWith ccWrapperFun runPackages.libc "";
