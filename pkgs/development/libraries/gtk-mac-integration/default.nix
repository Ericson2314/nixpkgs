{ stdenv, fetchFromGitLab, autoreconfHook, pkgconfig, glib, gtk-doc, gtk, gobject-introspection-tools }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    autoreconfHook pkgconfig gtk-doc gobject-introspection-tools
  ];
  buildInputs = [ glib ];
