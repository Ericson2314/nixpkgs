...
, dbus, dbus-glib, gtk3, gobject-introspection-tools
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    pkgconfig gobject-introspection-tools
  ];
  buildInputs = [
    dbus dbus-glib gtk3 gtk-doc docbook_xml_dtd_45 docbook_xsl libxslt libxml2
  ];
