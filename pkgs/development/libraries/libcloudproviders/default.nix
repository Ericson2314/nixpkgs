{ stdenv, fetchurl, meson, ninja, pkgconfig, gobject-introspection-tools, vala, gtk-doc, docbook_xsl, glib }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ meson ninja pkgconfig gobject-introspection-tools vala gtk-doc docbook_xsl ];
