...
, libxml2, perl, intltool, gettext, gnome3, gobject-introspection-tools, dbus, xvfb_run, shared-mime-info }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ pkgconfig intltool perl gobject-introspection-tools vala ];
