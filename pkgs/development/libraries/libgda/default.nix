{ stdenv, fetchurl, pkgconfig, intltool, itstool, libxml2, gtk3, openssl, gnome3, gobject-introspection-tools, vala, libgee
, overrideCC, gcc6
...
(if stdenv.isAarch64 then overrideCC stdenv gcc6 else stdenv).mkDerivation rec {
  ...
  nativeBuildInputs = [ pkgconfig intltool itstool libxml2 gobject-introspection-tools vala ];
