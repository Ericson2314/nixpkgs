...
, gnomeSupport ? true, sqlite, glib-networking, gobject-introspection-tools, vala
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ meson ninja pkgconfig gobject-introspection-tools vala glib ];
