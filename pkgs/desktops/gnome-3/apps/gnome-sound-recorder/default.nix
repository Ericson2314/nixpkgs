{ stdenv, fetchurl, pkgconfig, gettext, gobject-introspection-tools, wrapGAppsHook, gjs, glib, gtk3, gdk-pixbuf, gst_all_1, gnome3
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    pkgconfig gettext meson ninja gobject-introspection-tools
