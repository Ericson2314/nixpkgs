...
, pkgconfig, gtk3, glib, libsecret, libsoup, webkitgtk, gobject-introspection-tools, appstream-glib
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    ...
    desktop-file-utils gobject-introspection-tools appstream-glib
  ];
