...
, glib, appstream-glib, libsoup, polkit, isocodes, gspell, libxslt, gobject-introspection-tools, flatpak, fwupd
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    ...
    valgrind-light docbook_xsl gtk-doc desktop-file-utils gobject-introspection-tools
  ];
