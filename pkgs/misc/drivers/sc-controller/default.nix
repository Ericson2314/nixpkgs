...
, gtk3, gobject-introspection-tools, libappindicator-gtk3, librsvg
...
buildPythonApplication rec {
  ...
  nativeBuildInputs = [ wrapGAppsHook gobject-introspection-tools ];

  buildInputs = [ gtk3 -introspection libappindicator-gtk3 librsvg ];
